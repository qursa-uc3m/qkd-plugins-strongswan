 ...
 */
 ...
 static void register_algorithm_names(void) {
     ...
     proposal->register_token(proposal, "qkd_frodos1",
                              KEY_EXCHANGE_METHOD, KE_QKD_FRODO_SHAKE_L1, 0);
     proposal->register_token(proposal, "qkd_frodoa3", KEY_EXCHANGE_METHOD,
                              KE_QKD_FRODO_AES_L3, 0);
     proposal->register_token(proposal, "qkd_frodos3",
                              KEY_EXCHANGE_METHOD, KE_QKD_FRODO_SHAKE_L3, 0);
     proposal->register_token(proposal, "qkd_frodoa5", KEY_EXCHANGE_METHOD,
                              KE_QKD_FRODO_AES_L5, 0);
     proposal->register_token(proposal, "qkd_frodos5",
                              KEY_EXCHANGE_METHOD, KE_QKD_FRODO_SHAKE_L5, 0);
